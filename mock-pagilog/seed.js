// Annuaire d'exemple (employés + droits) et parc, au format « PAGILOG ».
// Les champs volontairement variés exercent les mappers tolérants de l'app :
// role, permissions (tableau), admin (booléen), pin.
...
module.exports = { directory, vehicles };
